...
namespace Sparky {
	...
	public:
		...
		static void RenderCameraIcon(const TransformComponent& transform, const Math::vec3& cameraPosition, int entityID = -1);
		static void RenderLightSourceIcon(const TransformComponent& transform, const Math::vec3& cameraPosition, int entityID = -1);
